...
**7 of 15 chapters complete** — Volume 3 underway. Module 1 complete.

| Module | Chapters | Status |
|--------|----------|--------|
| 1 — Foundations, Deepened | Ch 01–04 | ✅ Complete |
| 2 — Retrieval Engineering | Ch 05–08 | 🔄 In Progress (Ch 05–07 ✅) |
...
| 08 | Re-ranking and Advanced Retrieval | 🔜 Next |
